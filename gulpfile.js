...
gulp.task('default', function () {
    ...
    runSequence('sprite', 'images', 'font', ['sass', 'uglifyjs', 'html'], 'browser-sync', 'watch')
});
//线上自动部署
gulp.task('build', function () {
    runSequence('clean', 'sprite', 'images', 'font', ['sass', 'uglifyjs', 'html'], 'rev')
});
//清除任务
